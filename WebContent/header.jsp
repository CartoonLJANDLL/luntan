	...
	<nav class="nav navbar-inverse navbar-fixed-top" style="background-color:#ededed ;height: 80px;">
			<div class="container">
				<div class="navbar-header">
					...
					<a href="notlogin_index.html"><img src="img/LOGO.png"/></a>
				</div>
				<div id="menu" class="collapse navbar-collapse">
					<ul class="nav navbar-nav ">
					 ...
					 <div class="text-right" style="margin-top: 25px;">
						 <div id="userid_image">
							 <img src="img/tianyu.png" class="img-circle"/>
							 <a href="#">嘻哈侠盗</a>
						 </div>
						 <div id="login">
							 <button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#myModal">登录</button>
							 <a href="zhuce.jsp"><button type="button" class="btn btn-default">注册</button></a>
						 </div>
					</div>
				</div>
			</div>
